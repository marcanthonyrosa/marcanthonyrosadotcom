    ...
    <div className="max-w-2xl mx-auto px-6 py-16 sm:px-10">
      ...
      <section className="mb-14">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            I&apos;ve been doing product ever since - at Zipwhip through its acquisition by Twilio, at Deep 6 AI matching patients to clinical trials through the height of Covid, and most recently as Head of Product at Thread, where we created the category leading AI Inbox for MSPs.
          </p>
          <p>
